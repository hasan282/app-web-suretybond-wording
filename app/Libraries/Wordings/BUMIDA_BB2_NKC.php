...
class BUMIDA_BB2_NKC extends BaseWording
{
    ...
    public function content()
    {
        ...
        $this->setPoint('Maka kami, <b>PRINCIPAL</b> dan <b>SURETY</b> dengan ini mengikatkan diri untuk melakukan pembayaran maksimal jumlah tersebut di atas dengan baik dan benar bilamana <b>PRINCIPAL</b> tidak memenuhi kewajiban sebagaimana ditetapkan dalam instruksi kepada Peserta Lelang untuk pekerjaan __PROYEK_NAMA__ yang diselenggarakan oleh <b>OBLIGEE</b> pada __PROYEK_DATE__ di __PROYEK_ADDR__.');
        $this->setPoint('Adapun ketentuan dari Surat Jaminan ini adalah jika :', array('<b>PRINCIPAL</b> menarik kembali Penawarannya sebelum berakhirnya masa laku Penawaran yang dinyatakan dalam Formulir Penawaran,', 'Penawaran <b>PRINCIPAL</b> disetujui oleh <b>OBLIGEE</b> dalam masa laku Penawaran, dan <b>PRINCIPAL</b> telah :' . PHP_EOL . '(i) menyerahkan Jaminan Pelaksanaan yang diperlukan,' . PHP_EOL . '(ii) menandatangani Kontrak,' . PHP_EOL . '(iii) menandatangi dokumen perikatan lainnya sebagaimana yang diharuskan dalam Dokumen Lelang, atau', '<b>PRINCIPAL</b> gagal melaksanakan ketentuan seperti tersebut pada butir b diatas, dan telah membayar kepada <b>OBLIGEE</b> selisih (tidak melebihi nilai jaminan) antara perbedaan penawarannya dari penawaran yang lebih besar berikutnya, dimana <b>OBLIGEE</b> menunjuk kontraktor yang berikut itu untuk melaksanakan pekerjaan yang ditawarkannya,'), 'maka Jaminan ini menjadi batal dan tidak berlaku; sebaliknya jika tidak terjadi hal-hal seperti tersebut pada butir a, b dan c di atas maka Jaminan ini tetap berlaku dan efektif mulai dari tanggal __DATE_FROM__ sampai dengan tanggal __DATE_TO__.');
