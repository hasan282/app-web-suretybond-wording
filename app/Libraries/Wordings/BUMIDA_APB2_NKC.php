...
class BUMIDA_APB2_NKC extends BaseWording
{
    ...
    {
        $this->setPoint('Dengan ini dinyatakan, bahwa kami __PRINCIPAL__, __PRINCIPAL_ADDR__ sebagai Supplier, selanjutnya disebut <b>PRINCIPAL</b>, dan __ASURANSI__ __ASURANSI_ALAMAT__ sebagai Penjamin, selanjutnya disebut sebagai <b>SURETY</b>, bertanggung jawab dan dengan tegas terikat pada __OBLIGEE__, __OBLIGEE_ADDR__ sebagai Pemilik Pekerjaan, selanjutnya disebut <b>OBLIGEE</b> atas uang sejumlah __NILAI__.');
        ...
        $this->setPoint('Bahwa <b>PRINCIPAL</b> dengan suatu perjanjian tertulis __DOKUMEN__ telah mengadakan kontrak dengan <b>OBLIGEE</b> untuk pekerjaan __PROYEK_NAMA__ dengan Harga Kontrak yang telah disetujui sebesar __NILAI__ dan kontrak tersebut merupakan bagian yang tidak terpisahkan dari jaminan ini.');
        ...
        $this->setPoint('Jika <b>PRINCIPAL</b> telah melakukan pembayaran kembali kepada <b>OBLIGEE</b> seluruh jumlah Uang Muka dimaksud (yang dinyatakan dalam surat tanda bukti penerimaan olehnya) atau sisa Uang Muka yang wajib dibayar menurut Kontrak tersebut maka surat Jaminan ini menjadi batal dan tidak berlaku; sebaliknya jika tidak maka Surat Jaminan ini tetap berlaku dan efektif mulai dari tanggal __DATE_FROM__ sampai dengan __DATE_TO__ <i>(selama berlakunya Kontrak atau sampai pada tanggal Uang Muka telah dibayar kembali seluruhnya)</i>.');
