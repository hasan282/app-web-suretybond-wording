...
class BUMIDA_BB1_KC extends BaseWording
{
    ...
    {
        $this->setPoint('Dengan ini dinyatakan, bahwa kami __PRINCIPAL__ , </b> Alamat : __PRINCIPAL_ALAMAT__ sebagai Suplier, selanjutnya disebut <b>PRINCIPAL</b>, dan __ASURANSI__ Alamat : __ASURANSI_ALAMAT__ sebagai  Penjamin, selanjutnya disebut sebagai <b>SURETY</b>, bertanggung jawab dan dengan tegas terikat pada __OBLIGEE__ , alamat __OBLIGEE_ALAMAT__ sebagai Pemilik, selanjutnya disebut <b>OBLIGEE</b> atas uang sejumlah __NILAI__.');
        $this->setPoint('Maka kami, <b>PRINCIPAL</b> dan <b>SURETY</b> dengan ini mengikatkan diri untuk melakukan pembayaran maksimal jumlah tersebut di atas dengan baik dan benar bilamana <b>PRINCIPAL</b> tidak memenuhi kewajiban sebagaimana ditetapkan dalam instruksi kepada Peserta Lelang untuk pekerjaan __PROYEK_NAMA__ yang diselenggarakan oleh <b>OBLIGEE</b> pada tanggal <b>__DATE_FROM__</b> di _ALAMAT_PROYEK_.');
        $this->setPoint('Adapun ketentuan dari Surat Jaminan ini adalah jika :', array(
            ...
            'Penawaran <b>PRINCIPAL</b> disetujui oleh <b>OBLIGEE</b> dalam masa laku Penawaran, dan <b>PRINCIPAL</b> telah :' . PHP_EOL . '<b>(i)</b> menyerahkan Jaminan Pelaksanaan yang diperlukan,' . PHP_EOL . '<b>(ii)</b> menandatangani Kontrak,' . PHP_EOL . '<b>(iii)</b> menandatangi dokumen perikatan lainnya sebagaimana yang diharuskan dalam Dokumen Lelang, atau',
        ...
        ), 'maka Jaminan ini menjadi batal dan tidak berlaku; sebaliknya jika tidak terjadi hal-hal seperti tersebut pada butir a, b dan c di atas maka Jaminan ini tetap berlaku dan efektif mulai dari tanggal __DATE_FROM__ sampai dengan __DATE_TO__.');
