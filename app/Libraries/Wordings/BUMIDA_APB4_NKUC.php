...
class BUMIDA_APB4_NKUC extends BaseWording
{
    ...
    public function content()
    {
        ...
        }) . ' telah mengadakan kontrak dengan <b>OBLIGEE</b> untuk pekerjaan <b>' . $this->data('proyek_nama') . '</b> dengan Harga Kontrak yang telah disetujui sebesar __NILAI_PROYEK__ dan kontrak tersebut merupakan bagian yang tidak terpisahkan dari jaminan ini.');
