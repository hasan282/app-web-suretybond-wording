...
class BUMIDA_APB4_NKUC extends BaseWording
{
    ...
    public function content()
    {
        ...
        $this->setPoint('Ditandatangani serta dibubuhi materai di <b>' . $this->data('issued_place') . '</b> pada tanggal <b>' . $this->data('issued_date') . '</b>  PRINCIPAL <b>' . $this->data('principal') . '</b> SURETY <b>PT. ' . $this->data('asuransi_print') . ' </b>');
        $this->setContent();
        return $this;
    }
}
