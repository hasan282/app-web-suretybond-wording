...
class BUMIDA_APB1_KC extends BaseWording
{
    ...
    {
        $this->setPoint('Dengan ini dinyatakan, bahwa kami __PRINCIPAL__, __PRINCIPAL_ADDR__ sebagai Kontraktor, selanjutnya disebut <b>PRINCIPAL</b>, dan __ASURANSI__ __ASURANSI_ADDR__ sebagai Penjamin, selanjutnya disebut sebagai <b>SURETY</b>, bertanggung jawab dan dengan tegas terikat pada __OBLIGEE__, __OBLIGEE_ADDR__ sebagai Pemilik Pekerjaan, selanjutnya disebut <b>OBLIGEE</b> atas uang sejumlah __NILAI__.');
        ...
        $this->setPoint('Bahwa <b>PRINCIPAL</b> dengan suatu perjanjian tertulis __DOKUMEN__ telah mengadakan kontrak dengan <b>OBLIGEE</b> untuk pekerjaan __PEKERJAAN__ dengan Harga Kontrak yang telah disetujui sebesar __NILAI__ dan kontrak tersebut merupakan bagian yang tidak terpisahkan dari jaminan ini.');
