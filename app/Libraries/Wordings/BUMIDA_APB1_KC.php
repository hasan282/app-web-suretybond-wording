...
class BUMIDA_APB1_KC extends BaseWording
{
    ...
    public function content()
    {
        ...
        $this->setPoint('Jika <b>PRINCIPAL</b> telah melakukan pembayaran kembali kepada <b>OBLIGEE</b> seluruh jumlah Uang Muka dimaksud (yang dinyatakan dalam surat tanda bukti penerimaan olehnya) atau sisa Uang Muka yang wajib dibayar menurut Kontrak tersebut maka surat Jaminan ini menjadi batal dan tidak berlaku; sebaliknya jika tidak maka Surat Jaminan ini tetap berlaku dan efektif mulai dari tanggal __DATEFROM__ sampai dengan __DATETO__ <i>(selama berlakunya Kontrak atau sampai pada tanggal Uang Muka telah dibayar kembali seluruhnya)</i>.');
