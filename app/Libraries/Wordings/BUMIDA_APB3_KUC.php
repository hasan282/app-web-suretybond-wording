...
class BUMIDA_APB3_KUC extends BaseWording
{
    ...
    {
        $this->setPoint('Dengan ini dinyatakan, bahwa kami : __PRINCIPAL__ </b>, Alamat : __PRINCIPAL_ALAMAT__ sebagai Penyedia, selanjutnya disebut <b>TERJAMIN</b>, dan __ASURANSI__,   berkedudukan di Alamat :  __ASURANSI_ALAMAT__ sebagai penjamin, selanjutnya disebut <b>PENJAMIN</b>, bertanggung jawab dan dengan tegas terikat pada __OBLIGEE__ , __OBLIGEE_ALAMAT__ sebagai pemilik pekerjaan, selanjutnya disebut <b>PENERIMA JAMINAN</b> atas uang sejumlah __NILAI__.');
        $this->setPoint('Maka kami, <b>TERJAMIN</b> dan <b>PENJAMIN</b> dengan ini mengikatkan diri untuk melakukan pembayaran jumlah tersebut diatas dengan baik dan benar bilamana <b>TERJAMIN</b> tidak memenuhi kewajiban dalam melaksanakan pekerjaan __PROYEK_NAMA__ yang telah dipercaya kepadanya atas dasar Surat Perjanjian (Kontrak) dari <b>PENERIMA JAMINAN</b> __DOKUMEN__.');
        $this->setPoint('Surat Jaminan ini berlaku selama <bi>60 (ENAM PULUH ) hari</bi> kalender dan efektif mulai dari tanggal __DATE_FROM__ sampai dengan tanggal __DATE_TO__.');
