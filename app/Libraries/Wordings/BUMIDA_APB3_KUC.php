...
class BUMIDA_APB3_KUC extends BaseWording
{
    ...
    public function content()
    {
        ...
        $this->setPoint('<b>PENJAMIN</b> akan membayar kepada <b>PENERIMA JAMINAN</b> sejumlah nilai jaminan tersebut diatas atau sisa Uang Muka yang belum dikembalikan <b>TERJAMIN</b> dalam waktu paling lambat <bi>14(empat belas) hari kerja</bi> tanpa syarat (Unconditional) setelah menerima tuntutan pencairan secara tertulis dari <b>PENERIMA JAMINAN</b> berdasar Keputusan <b>PENERIMA JAMINAN</b> mengenai pengenaan sanksi akibat <b>TERJAMIN</b> cidera janji/wanprestasi. Menunjuk pada Pasal 1832 KUH Perdata dengan ini ditegaskan kembali bahwa <b>PENJAMIN</b> melepaskan hak-hak istimewa untuk menuntut supaya harta benda <b>TERJAMIN</b> lebih dahulu disita dan dijual guna dapat melunasi hutangnya sebagaimana dimaksud dalam Pasal 1831 KUH Perdata');
        ...
        $this->setPoint('Ditandatangani serta dibubuhi materai di ' . $this->data('issued_place') . ' pada <b>' . $this->data('dokumen_date') . '</b> PRINCIPAL <b>' . $this->data('principal') . '</b> SURETY <b>' . $this->data('asuransi_print') . '</b> ');
        $this->setContent();
        return $this;
    }
}
