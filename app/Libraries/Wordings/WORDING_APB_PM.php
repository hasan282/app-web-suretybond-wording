...
// Advance Payment Bond - Pemerintah
{
    ...
    public function content()
    {
        ...
        $this->setPoint('<b>PENJAMIN</b> akan membayar uang muka kepada <b>PENERIMA JAMINAN</b> atau sisa uang muka yang belum dikembalikan oleh <b>TERJAMIN</b> dalam waktu paling lambat 14 (Empat Belas) hari kerja ' . $this->conditional() . ' setelah menerima tuntutan pencairan secara tertulis dari <b>PENERIMA JAMINAN</b> berdasarkan keputusan <b>PENERIMA JAMINAN</b> mengenai pengenaan sanksi akibat <b>TERJAMIN</b> cidera janji.');
