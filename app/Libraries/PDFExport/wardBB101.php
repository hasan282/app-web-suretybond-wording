...
// Bid Bond - Pemerintah
{
    ...
    public function content()
    {
        ...
        $this->setPoint('Surat Jaminan ini berlaku selama dan efektif mulai <b>' . $this->data('days') . ' (' . $this->terbilang('days') . ')</b> hari kalender sejak tanggal <b>' . fdate($this->data('date_from'), 'DD1 MM3 YY2') . '</b> sampai dengan tanggal <b>' . fdate($this->data('date_to'), 'DD1 MM3 YY2') . '</b>.');
        $this->setPoint('<b>PENJAMIN</b> akan membayar kepada <b>PENERIMA JAMINAN</b> sejumlah nilai jaminan tersebut di atas dalam waktu paling lambat 14 (Empat Belas) hari kerja tanpa syarat (UNCONDITIONAL) setelah menerima tuntutan penagihan secara tertulis dari <b>PENERIMA JAMINAN</b> berdasar Keputusan <b>PENERIMA JAMINAN</b> mengenai pengenaan sanksi akibat TERJAMIN cidera janji/wanprestasi.');
