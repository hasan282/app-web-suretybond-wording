<div id="doc-target">
    ...
    <p class="text-center text-bold">Jaminan Pemeliharaan</p>
    <table class="w-100">
        <tr>
            <td>Nomor Jaminan : <b>22.08.02.1106.023489.DRAFT</b></td>
            <td class="text-right">Nilai : <b>Rp. 22.618.081,00</b></td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tr>
            <td></td>
            <td><strong>PT. FIBERHOME TECHNOLOGIES INDONESIA</strong></td>
            <td></td>
            <td><strong>PT. ASURANSI MAXIMUS GRAHA PERSADA Tbk, KANTOR CABANG BOGOR</strong></td>
            <td></td>
        </tr>
        <tr>
            <td></td>
