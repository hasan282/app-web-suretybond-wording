            ...
            <tbody>
                <?php for ($r = 0; $r < 10; $r++) : ?>
                    <tr>
                        ...
                        <td class="text-center border-left"><?php echo "Rp. " . number_format("55452259", 2, ",", "."); ?></td>
                        <td class="py-0 align-middle text-center border-left">
                            ...
                            <!-- <a href="/guarantee/detail" class="btn btn-secondary ml-1 btn-sm"><i class="fas fa-edit"></i></a> -->
                            <a href="/guarantee/detail" class="btn btn-danger ml-1 btn-sm"><i class="fas fa-trash"></i></a>
                            <!-- <a href="/guarantee/detail" target="_blank" class="btn btn-default ml-1 btn-sm text-bold"><i class="fas fa-external-link-alt"></i></a> -->
                        </td>
                    </tr>
                <?php endfor; ?>
            </tbody>
