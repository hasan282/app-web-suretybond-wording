                    ...
                    <form method="POST" action="#">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append ">
                                    <span class="input-group-text toggle-password cursor-pointer fa fa-eye-slash" data-target="old_pass"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text toggle-password cursor-pointer fa fa-eye-slash" data-target="newPass"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text toggle-password cursor-pointer fa fa-eye-slash" data-target="confirmPass"></span>
                                </div>
                            </div>
                        </div>
